...
export default function EHR() {
  ...
  const [user, setUser] = useState<fhir4.Patient | fhir4.Practitioner | null>(
    null,
  );
  ...
  let patientAge =
    patient && patient.birthDate ? formatAge(patient) || "Unknown" : "Unknown";
    ...
    <HelmetProvider>
      ...
      <div className="ehr">
        <div className="ehr-header">
          <div className="flex-row">
            ...
            <div>
              ...
              &nbsp; patient: <b>{patientName}</b>, age: <b>{patientAge}</b>
        ...
        <div className="ehr-status-bar">
          <div className="flex-row">
            <div className="text-muted" style={{ flex: "0 1 auto" }}>
              EHR Status bar
            </div>
