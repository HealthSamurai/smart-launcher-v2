...
export default function Login() {
  ...
  const { data: bundle, loading } = useFetch<
    fhir4.Bundle<fhir4.Patient | fhir4.Practitioner>
  >(fetchUrl, {
    headers: {
          ...
          <div className="col-sm-12">
            {noData && (
              <div className="alert alert-danger">
                <h5>
                  <i className="glyphicon glyphicon-exclamation-sign" /> No{" "}
                  {loginType === "provider" ? "Providers" : "Patients"} Found!
                </h5>
                <small>
                  Continue without a user, or return to the launch screen to
            ...
            <div className="form-group">
              ...
              <div className="help-text text-muted">
                This login is for demonstration purposes only. ANY password will
                be accepted.
              </div>
            </div>
