        ...
        <div className="row">
          <div className="col-xs-12">
            <h4 onClick={() => setOpen(!open)} style={{ margin: 0 }}>
              ...
              Launch App
              {!open && (
                <span className="text-muted small">&nbsp; Click to expand</span>
              )}
            </h4>
            ...
            <div className="col-xs-12 col-sm-4 col-lg-3">
              <div className="form-group">
                ...
                <select
                  ...
                  value={pkceMode}
                  onChange={(e) =>
                    setPkceMode(e.target.value as fhirclient.PkceMode)
                  }
                >
          ...
          <div className="row text-center">
            <div className="col-xs-12">
              <div className="panel-footer">
                <button className="btn btn-success pl-2 pr-2" onClick={launch}>
                  Authorize
                </button>
              </div>
            </div>
