  ...
  return (
    <div className="panel">
      ...
      <p className="alert alert-info mt-1">
        ...
        the <b>refresh_token</b> is a JWT, but it can be opaque string on other
        servers.
      </p>
      {code ? (
        mode === "json" ? (
            ...
            <table className="table table-condensed table-fixed">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <b>user:</b>&nbsp;
                    <span className="text-success">{code.user || ""}</span>
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  <td>
                    ...
                    <div className="text-muted small">
                      <Clip
                        txt="Expiration time on or after which the Token MUST NOT be
                      ...
                      <tbody>
                        {Object.keys(code.context).map((k, i) => (
                          <tr key={i}>
                            ...
                            <td>
                              <code>{JSON.stringify(code.context[k])}</code>
                            </td>
                          </tr>
                        ))}
                      </tbody>
        ...
        <div>
          ...
          <p className="text-muted" style={{ marginLeft: 20 }}>
            <i
              ...
              style={{ marginLeft: -20 }}
            />{" "}
            The <code>refresh_token</code> is only provided to apps using the{" "}
            <code>offline_access</code> or <code>online_access</code> scope.
          </p>
        </div>
      )}
    </div>
