  ...
  if (!meta) {
    return (
      <div className="text-danger">
        Failed to fetch metadata from the server
      </div>
    );
  }
  ...
  return (
    <>
      <p className="alert alert-info mt-1">
        ...
        extracted from the server's .well-known/smart-configuration endpoint
      </p>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="text-info">
                {(meta.code_challenge_methods_supported as string[]).map(
                  (m, i) => (
                    <span key={i}>
                      {i > 0 ? ", " : ""}
                      <code>{m}</code>
            ...
            <tr>
              ...
              <td className="text-info">
                {(meta.token_endpoint_auth_methods_supported as string[]).map(
                  (m, i) => (
                    <span key={i}>
                      {i > 0 ? ", " : ""}
                      <code>{m}</code>
            ...
            <tr>
              ...
              <td className="text-info">
                {(meta.scopes_supported as string[]).map((m, i) => (
                  <span key={i}>
                    {i > 0 ? ", " : ""}
                    <code>{m}</code>
                  </span>
            ...
            <tr>
              ...
              <td className="text-info">
                {(meta.response_types_supported as string[]).map((m, i) => (
                  <span key={i}>
                    {i > 0 ? ", " : ""}
                    <code>{m}</code>
                  </span>
            ...
            <tr>
              <th>Capabilities</th>
              <td className="text-info">
                {(meta.capabilities as string[]).map((m, i) => (
                  <span key={i}>
                    {i > 0 ? ", " : ""}
                    <code>{m}</code>
                  </span>
