...
const SCOPES = [
  {
    ...
    description: (
      <>
        Combine this with <code>fhirUser</code> or <code>profile</code> to get
        an ID Token and to be able to query information about the current user.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Combine this with <code>openid</code> to get an ID Token and to be able
  ...
  },
  {
    ...
    description: (
      <>
        Use this to get a Refresh Token and to be able to use the app for long
        periods of time without having to re-launch it.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Use this to get a Refresh Token and to be able to use the app for long
        periods of time without having to re-launch it, as long as the app is
        not closed.
      </>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <>
        Use this to obtain patient context in apps that use a standalone launch
        sequence.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Use this to obtain encounter context in apps that use a standalone
        launch sequence.
      </>
    ),
  },
    ...
    <>
          ...
          <div className="checkbox">
            <label>
              <input
                ...
                onChange={(e) => {
                  wellKnownScopeSet[e.target.checked ? "add" : "remove"](
                    s.value,
                  );
                  notifyChange();
                }}
      ...
      <div className="col-xs-12 col-md-8 col-lg-6">
        <div className="form-group">
          ...
          <span className="text-muted">(space separated list)</span>
          <input
            type="text"
