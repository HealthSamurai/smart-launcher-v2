        ...
        <table className="table table-condensed table-fixed">
          <tbody>
            <tr>
              <th>Software</th>
              <td>
                {meta.software?.name} {meta.software?.version}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="text-info">
                {
                  meta.rest?.[0].security?.extension
                    ?.find(
                      (e) =>
                        e.url ===
              ...
              <td className="text-info">
                {
                  meta.rest?.[0].security?.extension
                    ...
                    ?.extension?.find((e) => e.url === "token")?.valueUri
                }
              </td>
            </tr>
            <tr>
              ...
              <td className="text-info">
                {
                  meta.rest?.[0].security?.extension
                    ...
                    ?.extension?.find((e) => e.url === "introspect")?.valueUri
                }
              </td>
            </tr>
            <tr>
              ...
              <td>
                <Clip
                  max={500}
                  txt={meta.rest?.[0].resource?.map((r) => r.type)?.join(",\n")}
                />
              </td>
            </tr>
          </tbody>
