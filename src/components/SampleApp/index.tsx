...
export default function SampleApp() {
  ...
  if (!client) {
    if (
      launchParams.launch_type &&
      launchParams.launch_type.includes("standalone")
    ) {
      return (
        <div className="container">
          <div className="content sample-app">
            ...
            <div className="alert alert-info">
              ...
              sample app is about to perform a {launchParams.launch_type}{" "}
              launch. You can customize some options below and click
              "Authorize".
            </div>
            <LaunchPanel
              isOpen
      ...
      <div className="flex-row content sample-app" style={{ flex: "1 1 0px" }}>
        {client.state.clientPublicKeySetUrl && (
          <p className="alert alert-warning" style={{ flex: "1 1 100%" }}>
            ...
            <a
              href={client.state.clientPublicKeySetUrl}
              target="_blank"
